                    ...
                    <v-card class="mx-auto" elevation="2" outlined>
                        ...
                        <v-row class="ma-0">
                            <v-col md="8" offset-md="2">
                                <div class="text-h4 mt-5 mb-3">{{ task.title }}</div>
                            </v-col>
                        </v-row>
                                        ...
                                        <v-row v-for="(currentSolution, index) in solutions" :key="index" class="mt-1">
                                            ...
                                            <v-col md="4">
                                                <SolutionInspectionsList
                                                    v-bind:solution_id="currentSolution.id"
                                                    v-bind:isInspector="isInspector"
                                                ></SolutionInspectionsList>
                                            </v-col>
                                        </v-row>
                                    </v-container>
                        ...
                        <v-dialog v-model="removeDialog" max-width="350">
                            <v-card>
                                ...
                                <v-card-text> Это действие отменить невозможно </v-card-text>
                                ...
                                <v-card-actions>
                                    ...
                                    <v-btn color="green darken-1" text @click="removeTask()"> Delete </v-btn>
                                </v-card-actions>
                            </v-card>
                        </v-dialog>
                        <UserInfo />    
